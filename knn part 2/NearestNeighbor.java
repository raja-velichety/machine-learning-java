...
public class NearestNeighbor {
    ...
    public void loadTrainingData(String trainingFile) throws IOException{
     ...
     public void trainingError(String faultydata) throws IOException
    {
        Scanner inFile = new Scanner(new File(faultydata));
   ...
   /**************************************************************************************************************/
    ...
    public double validate(String validationFile) throws IOException
    {
        ...
        for(int i=0; i < numberRecords; i++)
        {
            ...
            // read attributes
           // System.out.println("number attributes in validate "+numberAttributes);
            for (int j=0; j< (numberAttributes-1);j++){
                attributeArray[j] = inFile.nextDouble();}
        ...
        if(errorRate!=0.0){
            System.out.println("faulty records is: "+(counter));
        }
    ...
    public void leaveoneout() throws IOException{
        ...
        for(int i=0;i<total_records_length;i++){
            ...
            trainingoutFile.println((total_records_length-1)+" "+6+" "+4+" "+10+" "+"unweighted");
